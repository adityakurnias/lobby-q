  ...
  <div class="min-h-[calc(100vh-120px)] flex items-center justify-center px-6 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-white mb-2">Masuk ke LobbyQ</h1>
        <p class="text-gray-400 text-sm">Kelola antrean mabar kamu dengan lebih baik.</p>
      </div>
      ...
      <p class="text-center text-sm text-gray-400 mt-6">
        Belum punya akun?
        <NuxtLink to="/register" class="text-primary hover:text-primary-light transition-colors font-medium">
          Daftar sekarang
        </NuxtLink>
      </p>
    </div>
